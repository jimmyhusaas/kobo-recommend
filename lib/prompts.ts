        ...
        items: {
          ...
          properties: {
            ...
            why_you: {
              type: "string",
              description:
                "說服性論述，必須直接引用讀者書單裡的具體書名。格式：「你讀了《A》和《B》，都在談 X，但你還沒有讀過從 Y 角度反駁這件事的書。這本書會讓你重新審視《A》裡你以為理所當然的假設。」——禁止使用「適合想拓展視野的讀者」「對你很有幫助」等空話；不引用具體書名就是不合格的回答。",
            },
            core_concepts: {
              type: "string",
...
推薦原則：
- why_you 是這次推薦品質的核心。必須用讀者書單裡的具體書名做論點，不是描述書的內容，是說明「為什麼這個讀者、在讀了這些書之後、現在需要讀這本」。
  ✗ 不合格：「這本書探討決策思維，適合想拓展視野的讀者。」
  ✓ 合格：「你讀了《原子習慣》和《底層邏輯》，兩本都在講執行面的框架。但你的盲區是從來沒有讀過正面挑戰這些框架的書。這本書讀完後，你會重新審視你在《原子習慣》裡深信不疑的幾個假設。」
